...
// Uncomment this if this is the correct component path in your project
...
type StudyIntensity = 'LIGHT' | 'MEDIUM' | 'HARD' | 'EXTREME'
    ...
    if (file) {
      ...
      reader.onload = (event) => {
        ...
        if (typeof result === 'string') {
          ...
          toast.success(
            'Image uploaded successfully! AI will analyze it.'
          )
        }
      }
    ...
    try {
      ...
      const aiRequest = {
        goals: formData.goals.map((goal) => ({
          ...
          subjects: goal.title.includes('DSA')
            ? ['DSA', 'Algorithms']
            : ['AI/ML', 'Python'],
        })),
      ...
      const response =
        await AITimetableGenerator.generate(aiRequest)
      ...
      toast.success(
        'AI has generated your perfect timetable! 🎉'
      )
    } catch (error) {
            ...
            <div className="space-y-6">
              ...
              {formData.hasCollege && (
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6 p-4 rounded-xl bg-secondary/30 border border-border">
                  <div className="space-y-3">
                    <Label htmlFor="collegeStartTime">
                      Start Time
                    </Label>
                    ...
                    <div className="flex flex-wrap gap-2">
                      {[
                        ...
                        <button
                          ...
                          onClick={() => {
                            const days = [
                              ...formData.collegeDays,
                            ]

                            if (days.includes(day)) {
                              setFormData({
                                ...formData,
                                collegeDays: days.filter(
                                  (d) => d !== day
                                ),
                              })
                            } else {
                  ...
                  <div className="flex items-center gap-3">
                    <input
                      ...
                      onChange={(e) =>
                        setFormData({
                          ...formData,
                          hasWeekendsOff: e.target.checked,
                        })
                      }
                      className="w-4 h-4 rounded"
                    />
                ...
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-blue-500/80">
                      AI will automatically avoid scheduling study
                      sessions during your fixed commitments. You can
                      also add commute times and other activities in
                      the description.
                    </p>
                  </div>
                </div>
                  ...
                  {[
                    ...
                    <button
                      ...
                      className={`flex-1 min-w-[140px] p-3 rounded-xl border text-left transition-all ${
                        formData.preferredStudyTime.includes(
                          time.id
                        )
              ...
              <div className="flex items-start gap-3">
                ...
                <div>
                  ...
                  <ul className="text-sm text-green-500/80 space-y-1">
                    <li>
                      • Smart scheduling based on your energy levels
                    </li>
                    <li>
                      • Priority-based time allocation for goals
                    </li>
                    <li>
                      • Optimal break timing for maximum retention
                    </li>
                    <li>
                      • Subject rotation to prevent burnout
                    </li>
                  </ul>
                </div>
              </div>
              ...
              <div className="flex items-start gap-3">
                ...
                <div>
                  ...
                  <p className="text-sm text-purple-500/80 mb-2">
                    Based on your goals, AI will allocate time
                    proportionally:
                  </p>
                  ...
                  {[
                    {
                      ...
                      value: `${generatedTimetable.summary.totalStudyHours}h`,
                    },
                    {
                      label: 'Weekly Sessions',
                      value: generatedTimetable.slots.length,
                    },
                    {
                      label: 'Daily Average',
                      value: `${(
                        generatedTimetable.summary.totalStudyHours / 7
                      ).toFixed(1)}h`,
                    },
                    {
        ...
        <div className="mb-8">
          <div className="flex items-center gap-3 mb-2">
            ...
            <div>
              ...
              <p className="text-muted-foreground">
                Let AI create your perfect study schedule based on
          ...
          <div className="flex items-start gap-3">
            ...
            <div>
              <div className="font-medium text-sm mb-1">
                AI Timetable Features
              </div>

              <ul className="text-xs text-muted-foreground space-y-1">
                <li>
                  • <strong>Smart Scheduling:</strong> AI analyzes
                  your energy patterns and preferences
                </li>
                <li>
                  • <strong>Goal Prioritization:</strong> Allocates
                  time based on goal priority and deadlines
                </li>
                <li>
                  • <strong>Image Analysis:</strong> Upload timetable
                  images for AI to extract schedule
                </li>
                <li>
                  • <strong>Export Options:</strong> Download as PDF,
                  Image, or copy to clipboard
                </li>
                <li>
                  • <strong>Real-time Adjustments:</strong> Regenerate
