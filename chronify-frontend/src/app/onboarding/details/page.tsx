// chronify-frontend/src/app/onboarding/details/page.tsx
...
import { AuthService, UserDetails } from "@/hooks/useAuth";
...
function DetailsContent() {
  ...
  /**
   * Converts the details page data into
   * fields supported by the Profile API.
   */
  const getProfilePayload =
    (): UpdateProfilePayload => {
      ...
      /*
       * Profession is directly supported
       * by Profile.
       */
      if (
      ...
      /*
       * For students, field of study is
       * useful as a hobby/interest until a
       * dedicated education table/field
      ...
      /*
       * For unemployed users, the current
       * backend Profile model has no
       * "seeking" field, so don't send it.
       *
       * Same for company, experience,
       * educationLevel, institution, etc.
       */

      return payload;
    };

  const saveProfileDataIfNeeded =
    async () => {
    ...
    async () => {
      ...
      if (role === "student") {
        ...
        if (
          ...
          errorMessage =
            "Please fill what you're seeking and your field";
        }
      }
  ...
  const handleSkip =
    async () => {
      ...
      try {
        ...
        /*
         * If supported Profile data exists,
         * save it.
         *
         * If everything is empty,
         * updateProfile is never called.
         */
        await saveProfileDataIfNeeded();
        ...
        console.error(
          "Failed to save skipped details:",
          error
        );
