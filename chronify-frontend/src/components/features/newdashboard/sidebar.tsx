...
//       {/* Desktop Sidebar */}
//       <aside className="hidden lg:flex flex-col w-64 h-screen bg-card border-r border-border/50 fixed left-0 top-0">
//         {/* Header */}
...
//             </div>
//             <div>
//               <h2 className="font-bold text-lg">Chronify</h2>
//               <p className="text-xs text-muted-foreground">Consistency Platform</p>
//             </div>
//           </div>
//         </div>
...
//             className="flex items-center gap-3 px-3 py-3 rounded-xl hover:bg-secondary/50 text-muted-foreground hover:text-foreground transition-all"
//           >
...
//             }}
//             className="flex items-center gap-3 w-full px-3 py-3 rounded-xl hover:bg-destructive/10 hover:text-destructive transition-all text-muted-foreground"
//           >
...
//                   </div>
//                   <div>
//                     <h2 className="font-bold">Chronify</h2>
...
//                     href={item.href}
//                     onClick={() => setMobileOpen(false)}
//                     className="flex items-center gap-3 px-3 py-3 rounded-xl hover:bg-secondary/50 text-muted-foreground hover:text-foreground"
//                   >
...
export function Sidebar({ collapsed, onToggle }: SidebarProps) {
  ...
  const navItems = [
    ...
    { icon: Calendar, label: 'Timetable', href: '/dashboard/timetable', badge: null },
    { icon: Target, label: 'Goals', href: '/dashboard/goals', badge: '3' },
    { icon: CheckSquare, label: 'Tasks', href: '/dashboard/tasks', badge: '5' },
    { icon: TrendingUp, label: 'Progress', href: '/dashboard/progress', badge: null },
    { icon: BarChart3, label: 'Analytics', href: '/dashboard/analytics', badge: null },
    { icon: BookOpen, label: 'Learning', href: '/dashboard/learning', badge: null },
    { icon: Users, label: 'Community', href: '/dashboard/community', badge: '12' },
