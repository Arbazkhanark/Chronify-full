...
export function TaskPoolGoalsPart({
  ...
  const handleDragStart = (e: React.DragEvent<HTMLDivElement>, type: string, data: any) => {
    if (isLocked) {
      e.preventDefault()
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-3">
              {goals.map(goal => (
                <div key={goal.id} className="space-y-2">
                  {/* Goal Card - Using plain div for native HTML5 drag events */}
                  <div
                  ...
                  {/* Milestones - Using plain div for native HTML5 drag events */}
