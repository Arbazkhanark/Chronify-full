// src/components/features/insight/InsightsClient.tsx
'use client'
      ...
      <div className="min-h-screen bg-gradient-to-b from-gray-50 to-white dark:from-gray-900 dark:to-gray-800 p-4 md:p-6 lg:p-8 transition-colors duration-200">
        <div className="max-w-7xl mx-auto">
          ...
          >
                ...
                <div className="flex items-start gap-3">
                  ...
                  <div className="flex-1">
                    ...
                    <p className="text-sm text-gray-600 dark:text-gray-400">
                      Track your study patterns, monitor streaks, and
                      get personalized recommendations to optimize
                      your learning journey. Your data updates in
                      real-time.
                    </p>
                  </div>
                      ...
                      <Tooltip>
                        <TooltipTrigger asChild>
                          <motion.div
                            variants={itemVariants}
                            whileHover={{ y: -2 }}
                            className={`bg-white dark:bg-gray-800 border rounded-lg p-3 hover:shadow-lg transition-all cursor-help ${
                      ...
                      return (
                        ...
                        >
                          <div className="flex items-start gap-3 mb-3">
                            ...
                            <div className="flex-1">
                              <h4 className="font-bold mb-1 dark:text-gray-200">
                                {rec.title}
                              </h4>
            ...
            <motion.div
              variants={itemVariants}
              className="text-xs text-gray-500 dark:text-gray-500 text-center border-t border-gray-200 dark:border-gray-800 pt-6 mt-4"
            >
              <p>
                Chronify AI Progress Insights provides comprehensive
                analytics for your learning journey. Track study
                streaks, monitor consistency scores, analyze
                productivity patterns, and get AI-powered
                recommendations. Perfect for students, professionals,
                and lifelong learners who want to optimize their
                study habits and achieve their goals faster.
              </p>
            </motion.div>
          </motion.div>
        </div>
